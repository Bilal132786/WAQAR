...
class TwoFactorCloner:
    ...
    def run(self):
        os.system("clear")
        print(f" db   d8b   db  .d8b.   .d88b.   .d8b.  d8888b.   ")
        print(f" `88   I8I   88 d8' `8b .8P  Y8. d8' `8b 88  `8D")
        print(f"  88   I8I   88 88ooo88 88    88 88ooo88 88oobY'    ")
        print(f"  Y8   I8I   88 88~~~88 88    88 88~~~88 88`8b")
        print(f" `8b d8'8b d8' 88   88 `8P  d8' 88   88 88 `88.  ")
        print(f" `8b8' `8d8'  YP   YP  `Y88'Y8 YP   YP 88   YD \033[92;1mX \033[1;37mI \033[92;1mY \033[1;37mA \033[92;1mD")
        print(f"\33[1;37m-------------------------------------------------------""")
        print(f"\033[92;1m>>  \033[1;37mOwner        \033[1;32m :  \033[92;1mX \033[1;37mI \033[92;1mY \033[1;37mA \033[92;1mD")
        print(f"\033[92;1m>>  \033[1;37mFacebook     \033[1;32m :\033[1;97m  WAQAR AHMED")
        print(f"\033[92;1m>>  \033[1;37mFacebook User\033[1;32m :\033[1;97m  WAQAR KING")
        print(f"\033[92;1m>>  \033[1;37mGithub       \033[1;32m :\033[1;97COMING SOON")
        print(f"\033[92;1m>>  \033[1;37mTool Type    \033[1;32m :\033[1;97m  \033[91;1mFREE")
